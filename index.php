...
<head>
    ...
    <!--DataTables-->
    <link rel="stylesheet" href="assets/plugins/datatables-bs4/css/dstaTables.bootstrap4.min.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-info elevation-4 bg-gray">
            ...
            <a href="#" class="brand-link bg-gray">
                <img src="assets/images/logo.png" alt="webpro" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <script src="assets/plugins/datatables-bootstrap4/dataTables.bootstrap4.min.js"></script>
    ...
    <script src="assets/plugins/datatables-buttons/js/buttons.htmls5.min.js"></script>
