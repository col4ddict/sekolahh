        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header row">
                  <div class="card-tittle h3 col-8">Edit Guru</div>
                  <div class="col-4">
...
<!--/.card-header-->
<div class="card-body">
    <form action="?m=teacher&s=update" method="post" entype="multipart/form-data">
    ...
    <div class="input-group mb-3">
        ...
        <input type="text" name="name" class="form-control" placeholder="Nama Guru*" value="<? = $r['nama'] ?>" required>
        </div>
    <div class="input-group mb-3">
        <div class="input-group-prepend">
