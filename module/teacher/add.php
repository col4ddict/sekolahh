        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header row">
                  <div class="card-tittle h3 col-8">Tambah Guru</div>
                  <div class="col-4">
...
<!--/.card-header-->
<div class="card-body">
    <form action="?m=teacher&s=save" method="post" entype="multipart/form-data">
    ...
    <div class="input-group mb-3">
        ...
        <input type="file" name="foto" accept=".jpg" class="form-control" placeholder="Nomor Handphone">
        </div> 
    <div class="input-group mb-3">
        <div class="input-group-prepend">
